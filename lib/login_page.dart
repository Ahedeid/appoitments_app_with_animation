import 'package:appoitments_app/main_pages/home_page.dart';
import 'package:appoitments_app/utils/hard_coded_data.dart';
import 'package:appoitments_app/utils/r.dart';
import 'package:appoitments_app/widgets/custom_flutter_logo.dart';
import 'package:appoitments_app/widgets/custom_text_field.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget _buildLoginButton(BuildContext context) =>
      ElevatedButton(
        style: ButtonStyle(
          backgroundColor: MaterialStateProperty.all(Color(0xFFFECEA5)),
          ...
          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
            ...
            child: Text(
              "Login",
              style: TextStyle(
                  color: R.primaryColor, fontWeight: FontWeight.bold),
            ),
          );
